    ...
    "propertySources": [
        ...
        },
        {
            ...
            "source": {
                ...
                "examples.example_int_list[0]": 1,
                "examples.example_int_list[1]": 2,
                "examples.example_str_list[0]": "example 1",
                "examples.example_str_list[1]": "example 2",
                "examples.example_str_list[2]": "example 3",
                "examples.example_float_list[0]": 1.1,
                "examples.example_float_list[1]": 2.2,
                "examples.example_float_list[2]": 3.3,
                "unwanted.types[0]": "branded",
            },
        },
    ],
    "state": None,
