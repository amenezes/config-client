...
class CFenv:
    ...
    @property
    def space_name(self):
        return glom(self.vcap_application, 'space_name')

    @property
    def organization_name(self):
        return glom(self.vcap_application, 'organization_name')

    @property
    def application_name(self):
        return glom(self.vcap_application, 'application_name')

    @property
    def uris(self):
        return glom(self.vcap_application, 'uris')
