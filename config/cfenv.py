...
class CFenv:
    ...
    def configserver_access_token_uri(self, vcap_path: str = '.0.credentials.access_token_uri') -> Any:
        path = self._format_vcap_path(vcap_path)
        return glom(self.vcap_services, path, default='')
    ...
    def configserver_client_secret(self, vcap_path: str = '.0.credentials.client_secret') -> Any:
        path = self._format_vcap_path(vcap_path)
        return glom(self.vcap_services, path, default='')
